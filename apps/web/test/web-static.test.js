...
for (const [label, html] of pages) {
  for (const expected of [
    ...
    'Secure USA-only KYC intake',
    'local encrypted archive references',
    'manual account approval',
    'Member Network Controls',
    'USA-only membership',
    'Onboarding Gate',
    ...
    'Wallet and Protocol Capabilities',
    'P2P Trade Capture',
    'locally sanitized item photos',
    'FMV Pricing Assistant',
    '1 btc equal to 1 USD for accounting math',
    'Consent-gated AI identification and automated marketplace providers are prepared but not active',
    'Multichain Footprint',
    'Member Governance',
    'Time Bank',
    'custom professional rate',
    'Offline Mode',
    'Offline Settlement Loop',
    'matching QR copies',
    'business-instance btc 5000 is never substituted as its fallback',
    'Recovery packet and settlement plan exports',
    'No transfer',
